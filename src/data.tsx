...
export type ExtraData = Readonly<
	{
		[K in typeof data[number]["key"]]: Readonly<
			(((typeof data)[number] & { key: K })["type"] extends "story"
				? { src: string; blurb: ComponentChildren; startOf?: string }
				: ExtraPuzzle)
		>;
	}
>;
...
export const extraData: ExtraData = {
	...
	dependencies: { blurb: "Laying the groundwork for things to come.", src: "ch2" },
	div: {
	...
	optimization: { blurb: "In pursuit of higher standards.", src: "ch3" },
	reverse: {
		blurb: <>Let's switch things up.</>,
		extraDesc: "Reverse the string!",
		solveBlurb: "The new era of string operations begins.",
	},
	dotenv: { blurb: "A hidden file reveals many secrets.", src: "ch4" },
	permutation: {
		blurb: "Lexicographically challenging.",
		extraDesc:
			"Find the next lexicographically smallest permutation of letters. For instance, abc goes to acb.",
		solveBlurb: "Congratulations! I think you're ready for the real challenges.",
	},
	mutability: { blurb: "Everything can change.", src: "ch5" },
	classic: {
		blurb: "A good old fashioned puzzle.",
		extraDesc: <>
			Crack your first <b>SUBKEY</b>.
		</>,
		solveBlurb: "Access granted.",
	},
	casting: { blurb: "A new perspective offers clarity.", src: "ch6" },
	leapfrog: { blurb: "" },
	abc: { blurb: "An alphabetic exercise in decreasing entropy." },
	arithmetic: { blurb: "Put two and two together." },
	"rot-13": {
		blurb: "(This puzzle has almost nothing to do with ROT-13.)",
		extraDesc: "But try ROT-13 anyways! Who knows, maybe it'll work.",
	},
	"taylor-series": { blurb: "A most elementary expansion." },
} as const;
...
export const messages = [{
	...
	sequelTo: "coffee",
	from: "Cyril Sharma",
	subject: "🎁 A gift for our devoted coders",
	src: "present",
}, {
	key: "karen1",
	minStageKey: "reverse",
	...
	expectedMinutes: 40,
	from: "Brijesh Patel",
	subject: "Revamped lunch catering!",
	src: "brijesh1",
}, {
	key: "ishan",
	minStageKey: "reverse",
	...
	expectedMinutes: 90,
	from: "Egor Gagushin",
	subject: "Advisory on register naming",
	src: "naming",
}, {
	key: "interns",
